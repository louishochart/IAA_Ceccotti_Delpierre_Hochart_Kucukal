...
content_path = "../images/contenu/lille1.jpg"

#########################################################################


## permet de charger une image et de la transformer en Tensor normalisé (en diminuant sa taille pour ne pas dépasser la mémoire GPU)
def load_image(img_path, max_size=500, shape=None):
  ...
  in_transform = transforms.Compose([
    transforms.Resize((int(1.16*size),size )),
    transforms.ToTensor(),
...
## permet de convertir le tenseur de sortie en image
...
torch.utils.model_zoo.load_url('https://download.pytorch.org/models/vgg19-dcbb9e9d.pth', model_dir='./')
...
# conv4_2 is excluded because it is the content layer
style_weights = {
                #  'conv1_1': 0.75,
                 'conv1_1': 1,
                #  'conv2_1': 0.5,
